...
public class CreateJPanel extends javax.swing.JPanel {
     ...
     */
    public CreateJPanel(Person per) {
        initComponents();
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(layout.createSequentialGroup()
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addComponent(lblPassportNum, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(txtPassportNum, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        person.setMaritalStatus(txtMaritalStat.getText());
        person.setNationality(txtNationality.getText());
        person.setEducation(txtQualification.getText());
        person.setPhoneNumber(txtPhone.getText());
        person.setEmail(txtEmail.getText());
        person.setFaxNumber(txtFax.getText());
        person.setTelephoneNumber(txtTelephone.getText());
        person.setDriversLicenseState(txtLicenseState.getText());
        person.setDriversLicenseNumber(txtLicenseNumber.getText());
        person.setSocialSecurityNumber(txtSsn.getText());
        person.setPassport(txtPassportNum.getText());
